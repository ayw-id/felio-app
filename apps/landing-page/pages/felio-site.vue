<template>
  <div class="w-full">
      ...
      <BaseSection>
        ...
        >
          ...
          >
            ...
            <span class="text-header-gradient">Successful Business</span>
          </h1>
          <p
            data-aos="fade-down"
            data-aos-once="true"
          ...
          >
            Bikin website untuk semua kebutuhan bisnismu dengan mudah dan
            <b>GRATIS</b>.
          </p>
          <div
            data-aos="fade-up"
    ...
    <section class="w-full my-36">
      <BaseSection style="align-items: center">
        ...
        <div
          data-aos="fade-left"
          class="col-span-12 lg:col-span-5 space-y-6 px-4 sm:px-6 mt-20"
        >
          <h2 class="text-4xl font-semibold">Bangun Kepercayaan Pelanggan</h2>
          <p class="paragraph">
            Website adalah bagian identitas brand. Memiliki website yang
            profesional membuat pelangganmu makin mudah percaya pada brandmu.
          </p>
          <p class="paragraph">
            Link-in-bio, landing page, blog, hingga protofolio bisa kamu buat di
            Felio.ID.
          </p>
        </div>
      </BaseSection>
    ...
    <section class="w-full my-36">
      <BaseSection style="align-items: center">
        <div data-aos="fade-left" class="col-span-12 lg:col-span-7 sm:hidden">
          <div class="w-full">
            <img
              :src="require('~/assets/img/nefa-cc.webp')"
              class="w-[95%]"
        ...
        <div
          ...
          class="col-span-12 lg:col-span-5 space-y-6 px-4 sm:px-6 mt-20"
        >
          <h2 class="text-4xl font-semibold">Maksimalkan Kreatifitasmu</h2>
          <p class="paragraph">
            Mulai dengan template yang sesuai dengan bisnis kamu, atau dari
            halaman kosong.
          </p>
          <p class="paragraph">
            Dengan fitur web builder yang lebih kompleks, Kamu bisa mendesain
            websitemu lebih leluasa dan inovatif.
          </p>
        </div>
        <div
          data-aos="fade-left"
          class="col-span-12 lg:col-span-7 hidden sm:block"
        >
          <div class="w-full">
            <img
              :src="require('~/assets/img/nefa-cc.webp')"
    ...
    <section class="w-full my-36">
      <BaseSection style="align-items: center">
        ...
        >
          ...
          <p class="paragraph">
            Bagikan link websitemu di media social yang kamu miliki
          </p>
          <p class="paragraph">
            Kamu juga bisa pasang link produk, atau import dari #FelioStore.
          </p>
        </div>
      </BaseSection>
    </section>
    ...
    <section class="w-full my-36">
      <BaseSection style="align-items: center">
        ...
        <div
          ...
          class="col-span-12 lg:col-span-5 space-y-6 px-4 sm:px-6 mt-20"
        >
          <h2 class="text-4xl font-semibold">Terima Pembayaran Tanpa Ribet</h2>
          <p class="paragraph">
            Felio.ID menyediakan beragam metode pembayaran untuk memudahkan
            palanggan kamu.
          </p>
          <p class="paragraph">
            Kamu cukup memasang produkmu dari #FelioStore, dan mulai terima
            pesanan.
          </p>
        </div>
        <div
    ...
    <section class="w-full my-36">
      <BaseSection style="align-items: center">
        ...
        <div
          ...
          class="col-span-12 lg:col-span-5 space-y-6 px-4 sm:px-6 mt-20"
        >
          <h2 class="text-4xl font-semibold">Lebih Dekat Dengan Pelangganmu</h2>
          <p class="paragraph">
            Pantau traffic dan data pelangganmu untuk mengetahui apa yang mereka
            mau.
          </p>
          <p class="paragraph">
            Saat websitemu sudah dipublish, fitur analitycs akan otomatis aktif
          </p>
        </div>
      </BaseSection>
    </section>
    ...
    >
      ...
      >
        ...
        >
          <h2 class="text-4xl font-semibold">Your Domain, Your Brand</h2>
          <div class="space-y-2" style="">
            <p class="paragraph text-sm xl:text-base">
              Buat websitemu mudah dikenali dengan nama domain yang sesuai
              dengan bisnismu.
            </p>
            <p class="paragraph text-sm xl:text-base">
              Felio.ID menyediakan beragam domain extension yang kamu butuhkan
            </p>
          </div>
        </div>
